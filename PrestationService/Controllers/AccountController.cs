...
namespace PrestationService.Controllers
{
    ...
    public class AccountController : Controller
    {
          ...
          public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // HttpContext.Session["TEST"] = model.userName;// User.Identity.GetUserId();
            //var prof = bd.professionnels.Where(a => a.prenom.Equals(model.userName)).FirstOrDefault();
         
            //var prof = new Professionnel();
            //prof.prenom = model.userName;
            //prof.mail = model.Email;

            //HttpContext.Session["Id"] = prof.IdProfessionnel;
            //HttpContext.Session["Prof"] = prof.prenom;
            //HttpContext.Session["nom"] = prof.nom;
            //HttpContext.Session["nomComplet"] = prof.nomComplet;
            //HttpContext.Session["ninea"] = prof.ninea;
            //HttpContext.Session["mail"] = prof.mail;
            //HttpContext.Session["Specialite"] = prof.specialite;
            //HttpContext.Session["Photo"] = prof.photo;
            //HttpContext.Session["MailProf"] = prof.mail;
            //HttpContext.Session["IdProf"] = prof.IdProfessionnel;

            if (!ModelState.IsValid)
            {
                //using ( bdServiceContext bd = new bdServiceContext())
                //{
                //    var obj = bd.professionnels.Where(a => a.prenom.Equals(model.userName)).FirstOrDefault();
                //    if (obj != null)
                //    {
                //        Session["UserID"] = obj.IdProfessionnel.ToString();
                //        Session["UserName"] = obj.prenom.ToString();
